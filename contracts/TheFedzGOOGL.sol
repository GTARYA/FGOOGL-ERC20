...
// Compatible with OpenZeppelin Contracts ^5.5.0 pragma solidity ^0.8.27; 
...
contract TheFedzGOOGL is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit 
{ constructor(address initialOwner) 
ERC20("The Fedz GOOGL", "FGOOGL") 
Ownable(initialOwner) 
ERC20Permit("The Fedz GOOGL") {} 
function pause() public onlyOwner 
{ _pause(); } function unpause() public onlyOwner
{ _unpause(); } function mint(address to, uint256 amount) public onlyOwner { _mint(to, amount); } 
